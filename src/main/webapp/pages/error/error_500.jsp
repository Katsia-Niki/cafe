    ...
    <div class="row align-items-center" style="height: 100%">
        <div class="col">
            ...
            <form class="form-inline" action="controller">
                ...
                <button type="submit" class="btn btn-outline-primary my-2 my-sm-0">${back_to_main}</button>
            </form>
        </div>
        <div class="col">
            <img src="${pageContext.request.contextPath}/assets/images/500-error.png" alt="">
        </div>
    </div>
</div>
</body>
