...
public class GoToPlaceOrderPageCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        BigDecimal cartSum = new BigDecimal(session.getAttribute(CART_SUM).toString());
    ...
    private Map<String, String> createOrderData(BigDecimal pointsForAccount,
        ...
        orderData.put(POINTS_FOR_ACCOUNT, pointsForAccount.toString());
        orderData.put(POINTS_FOR_CASH, pointsForCash.toString());
        orderData.put(CART_SUM, cartSum.toString());
        orderData.put(MIN_PICK_UP_TIME, minPickUpTime.toString());
        orderData.put(MAX_PICK_UP_TIME, maxPickUpTime.toString());
        orderData.put(USER_ID_SESSION, userId);
