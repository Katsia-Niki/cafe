...
public class GoToEditMenuPageCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        session.removeAttribute(UPDATE_MENU_ITEM_RESULT);

        String menuItemIdToEdit = request.getParameter(MENU_ITEM_ID_TO_EDIT);
    ...
    Map<String, String> createMenuItemData(MenuItem menuItem) {
       ...
       // menuItemData.put(MENU_ITEM_IMAGE_SESSION, menuItem.getImage()); fixme
        return menuItemData;
    }
}
