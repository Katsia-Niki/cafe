...
public class EditMenuItemCommand implements Command {
    ...
    private void updateMenuItemData(HttpServletRequest request, Map<String, String> menuItemData) {
        menuItemData.put(MENU_ITEM_NAME_SESSION, request.getParameter(MENU_ITEM_NAME));
        menuItemData.put(MENU_ITEM_DESCRIPTION_SESSION, request.getParameter(MENU_ITEM_DESCRIPTION));
        menuItemData.put(MENU_ITEM_PRICE_SESSION, request.getParameter(MENU_ITEM_PRICE));
        menuItemData.put(MENU_ITEM_AVAILABLE_SESSION, request.getParameter(MENU_ITEM_IS_AVAILABLE));
    }
}
